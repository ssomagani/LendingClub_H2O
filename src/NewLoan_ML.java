...
public class NewLoan_ML {

	SimpleDateFormat sdf = new SimpleDateFormat("MMM-yyyy");
	
    public static void main (String[] args) {
        NewLoan_ML ml = new NewLoan_ML();
        String[] splitArgs = args[0].split(",", -1);
        ml.run(splitArgs);
    }
	...
	public long run(String[] args) {
        ...
        try {
        	mths_since_rcnt_il = Double.parseDouble(args[67]);
        } catch (Exception e){}
        ...
        try {
        	total_bal_il = Double.parseDouble(args[68]);
        } catch (Exception e){}
        ...
        Double il_util = 0d;
        try {
        	il_util = Double.parseDouble(args[69]);
        } catch (Exception e){}
        ...
        try {
        mo_sin_old_il_acct = Double.parseDouble(args[84]);
        } catch (Exception e){}
        ...
        row.put("mths_since_recent_inq", args[91]);
        ...
        row.put("num_tl_120dpd_2m", args[103]);
        ...
        String secAppEarliestCrLine = args[118];
...
//        row.put("hardship_start_date", args[134]);
//        row.put("hardship_end_date", args[135]);
//        row.put("payment_plan_start_date", args[136]);
